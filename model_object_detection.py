...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb 22 22:42:56 2018
...
from capsnet import conv_caps_layer,fully_connected_caps_layer


class Model_Object_Detection(ModelBase):
    """
    ...
    def evaluate_dataset(self, images, labels, batch_size=10):
        ...
        loss = tf.add(margin_loss, 0.005 * reconstruction_loss, name="loss")
